...
<head>
    <title>English ON THGE GO!</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row no-gutters d-flex align-items-center align-items-stretch">
                <div class="col-md-4 d-flex align-items-center py-4">
                    <a class="navbar-brand" href="index.html">English<span>ON THE GO!</span></a>
                </div>
        ...
        <div class="container d-flex align-items-center px-4">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a href="courses.html" class="nav-link">Cursos</a></li>
                    <li class="nav-item"><a href="teacher.html" class="nav-link">Instructores</a></li>
                    <li class="nav-item active"><a href="blog.html" class="nav-link">Testimonios</a></li>
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <h1 class="mb-2 bread">Opiniones</h1>
                    <p class="breadcrumbs"><span class="mr-2"><a href="index.html"><i class=""></i></a></span> <span class="mr-2"><a href="index.html"><i class=""></i></a></span> <span> <i class=""></i></span></p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 sidebar ftco-animate">
                    ...
                    <div class="sidebar-box ftco-animate">
                        <h3>Niveles</h3>
                        <ul class="categories">
                            <li><a href="#">Basic User<span>(A1,A2)</span></a></li>
                            <li><a href="#">Independent User<span>(B1,B2)</span></a></li>
                            <li><a href="#"> Proficient User<span>(C1,C2)</span></a></li>
                    ...
                    <div class="sidebar-box ftco-animate">
                        <h3>Guias de Apoyo</h3>
                        <ul class="categories">
                            <li><a href="#">Vocabulary  <span></span></a></li>
                            <li><a href="#">Sentences <span></span></a></li>
                            <li><a href="#">Reading<span></span></a></li>
                            <li><a href="#">Listening<span></span></a></li>
                        </ul>
                    </div>
