 ...
 <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-30">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">ALTA TUTOR</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Ingresa Datos del Tutor</h3>
                                        </div>
                                        <hr>
<form action = "{{ route('guardatutor')}}" method = "POST">
{{csrf_field()}}
...
@endif	<p>
<table><tr><td>Clave Tutor</td><td style="width:100px"><input  class="form-control" type='text'  name='idtut' value="{{ $idtut}}" >
</td>
</td></tr></table>
<br>
